...
class ObjectMainDetection {
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/happy.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/sad.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/angry.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
